...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ asset('conf-team') }}">チーム設定</a>
        </li>
        <li class="nav-item">
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_{{ $team->status }}">
                    ...
                    <td>{{ $team->name }}</td>
                    <td>{{ $team->created_at->format('Y年m月d日') }}</td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="{{ $team['id'] }}" data-bs-status="{{$team['status']}}" data-bs-name="{{$team['name']}}" data-bs-order="{{$team['display_order']}}"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
