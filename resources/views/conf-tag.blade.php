...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ asset('conf-tag') }}">タグ管理</a>
        </li>
        <li class="nav-item">
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_{{ $tag->status }}">
                    ...
                    <td>{{ $tag->name }}</td>
                    <td><span class="badge text-white pt-1" style="background-color:{{ $tag['color'] }}">{{ $tag['name'] }}</span></td>
                    <td>{{ $tag->created_at->format('Y年m月d日') }}</td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="{{ $tag['id'] }}" data-bs-status="{{$tag['status']}}" data-bs-name="{{$tag['name']}}" data-bs-color="{{$tag['color']}}" data-bs-order="{{$tag['display_order']}}"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
