...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ asset('conf-group') }}">部署設定</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12">
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_{{ $department->status }}">
                    ...
                    <td>{{ $department->created_at->format('Y年m月d日') }}</td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="{{ $department['id'] }}" data-bs-status="{{$department['status']}}" data-bs-name="{{$department['name']}}" data-bs-order="{{$department['display_order']}}"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
