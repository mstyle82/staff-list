    ...
    <div class="card border border-0">
        <div class="row g-0">
            ...
            <div class="col-md-10 mt-5">
                <form action="<?php echo e(asset('myprof-image.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            ...
            <form method="POST" action="<?php echo e(asset('/edit-myprof.update')); ?>">
            <?php echo csrf_field(); ?>
                <div class="row mx-1">
                        <p>
                            <input type="hidden" name="id" id="id" class="form-control" value="<?php echo e($edit_data->id); ?>">
                        ...
                        <p>
                            <input type="hidden" name="user_id" id="user_id" class="form-control" value="<?php echo e($edit_data->user_id); ?>"></p>
                        <p>
                        <div class="col-md-6 mt-3">
                            <label class="form-label" style="font-weight:bold">名前 :</label>
                            <input type="text" class="form-control w-75" name="name" id="name" placeholder="" value="<?php echo e($edit_data->name); ?>">
                        </div>
                        <div class="col-md-6 mt-3">
                            <label class="form-label" style="font-weight:bold">かな :</label>
                            <input type="text" class="form-control w-75" name="kana" id="kana" placeholder="" value="<?php echo e($edit_data->kana); ?>">
                        </div>
                        <div class="col-md-6 mt-3">
                            <label class="form-label" style="font-weight:bold">生年月日 :</label>
                            <input type="date" class="form-control w-75" name="birthday" id="birthday" placeholder="" value="<?php echo e($edit_data->birthday); ?>">
                        </div>
                        <div class="col-md-6 mt-3">
                            <label class="form-label" style="font-weight:bold">性別 :</label>
                            <!--<input type="text" class="form-control w-75" name="gender" id="gender" placeholder="" value="<?php echo e($edit_data->gender); ?>">-->
                    ...
                    <div class="col-md-8 mt-3">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control w-25" name="office_tell" id="office_tell" placeholder="" value="<?php echo e($edit_data->office_tell); ?>">
                        </div>
                        <div class="col-md-12 mt-3">
                            <label class="form-label" style="font-weight:bold">緊急連絡先 :</label>
                            <input type="text" class="form-control w-25" name="home_tell" id="home_tell" placeholder="" value="<?php echo e($edit_data->home_tell); ?>">
                        </div>
                        <div class="col-md-12 mt-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/mikami/staff-list/resources/views/edit-myprof.blade.php ENDPATH**/ ?>