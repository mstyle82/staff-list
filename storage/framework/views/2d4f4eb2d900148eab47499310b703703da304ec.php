...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo e(asset('conf-group')); ?>">部署設定</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12">
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_<?php echo e($department->status); ?>">
                    <td style="display:none;"><?php echo e($department->id); ?></td>
                    <td>
                    ...
                    <td><?php echo e($department->display_order); ?></td>
                    <td><?php echo e($department->name); ?></td>
                    <td><?php echo e($department->created_at->format('Y年m月d日')); ?></td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="<?php echo e($department['id']); ?>" data-bs-status="<?php echo e($department['status']); ?>" data-bs-name="<?php echo e($department['name']); ?>" data-bs-order="<?php echo e($department['display_order']); ?>"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <form method="POST" action="group_store">
              ...
              <div class="modal-body">
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">部署名:</label>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form method="POST" action="group_update">
        <?php echo csrf_field(); ?>
            <div class="modal-body">
                <div class="mb-3">
                    <p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/mikami/staff-list/resources/views/conf-group.blade.php ENDPATH**/ ?>