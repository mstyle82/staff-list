...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo e(asset('conf-team')); ?>">チーム設定</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12">
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_<?php echo e($team->status); ?>">
                    <td style="display:none;"><?php echo e($team['id']); ?></td>
                    <td>
                    ...
                    <td><?php echo e($team->display_order); ?></td>
                    <td><?php echo e($team->name); ?></td>
                    <td><?php echo e($team->created_at->format('Y年m月d日')); ?></td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="<?php echo e($team['id']); ?>" data-bs-status="<?php echo e($team['status']); ?>" data-bs-name="<?php echo e($team['name']); ?>" data-bs-order="<?php echo e($team['display_order']); ?>"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">新規チーム登録</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
          <form method="POST" action="team_store">
              <?php echo csrf_field(); ?>
              <div class="modal-body">
                <div class="mb-3">
                    <label for="recipient-name" class="col-form-label">チーム名:</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/mikami/staff-list/resources/views/conf-team.blade.php ENDPATH**/ ?>