...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo e(asset('conf-tag')); ?>">タグ管理</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12">
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr class="line_<?php echo e($tag->status); ?>">
                    <td style="display:none;"><?php echo e($tag->id); ?></td>
                    <td>
                        <?php if( $tag['status'] === 0): ?>
                    ...
                    <td><?php echo e($tag->display_order); ?></td>
                    <td><?php echo e($tag->name); ?></td>
                    <td><span class="badge text-white pt-1" style="background-color:<?php echo e($tag['color']); ?>"><?php echo e($tag['name']); ?></span></td>
                    <td><?php echo e($tag->created_at->format('Y年m月d日')); ?></td>
                    <td>
                        <button type="button" class="btn-original" data-bs-toggle="modal" data-bs-target="#updateModal"  data-bs-id="<?php echo e($tag['id']); ?>" data-bs-status="<?php echo e($tag['status']); ?>" data-bs-name="<?php echo e($tag['name']); ?>" data-bs-color="<?php echo e($tag['color']); ?>" data-bs-order="<?php echo e($tag['display_order']); ?>"><i class="far fa-edit mr-3"></i></button>
                    </td>
                </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">新規タグ登録</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
          <form method="POST" action="conf_store">
              <?php echo csrf_field(); ?>
              <div class="modal-body">
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">タグ名:</label>
                        <input type="text" class="form-control" name="get_name">
                    </div>
                    <div class="mb-3">
                        <label for="exampleColorInput" class="form-label">カラー:</label>
                        <input type="color" class="form-control form-control-color" name="get_color" value="#563d7c"title="Choose your color">
                    </div>
                    <div class="mb-3 mt-3">
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="conf_update">
              <?php echo csrf_field(); ?>
              <div class="modal-body">
                <div class="mb-3">
                  <p>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleColorInput" class="form-label">カラー:</label>
                        <input type="color" class="form-control form-control-color w-25" name="color" id="edit-color" title="Choose your color">
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="recipient-name" class="col-form-label">表示順:</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/mikami/staff-list/resources/views/conf-tag.blade.php ENDPATH**/ ?>